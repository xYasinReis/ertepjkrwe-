...
var oyun = [
  ...
  `🔒 Sponsor | webvoserver.net`,
  `🔔 Abone Rol için | -abone-sistemi `,
  `🤖 Bot List Sistemi için | -botlist-sistemi `,
...
db.set(`sahipsure_${message.author.id}`, Date.now());
  ...
  .setDescription(`<a:developer_transparent:817040841105342535> <@${message.author.id}> **İşte Havalı Sahibim.**`)
...
let kisi = "779983912515403776" //sahip id
