...
return message.channel.send(new Discord.MessageEmbed().setTitle('<a:tik:817000434374803466> **Başarıyla '+`${args[0]}`+' adet mesaj silindi.**')).then(m => m.delete({timeout: 5000}));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
